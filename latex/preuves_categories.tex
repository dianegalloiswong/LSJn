...
Voici un calcul de séquents pour la logique linéaire. Les séquents sont les mêmes que ceux de \LK\ : deux listes de formules $\G$ et $\D$, avec la notation $\G \vdash \D$. Les connecteurs, différents, sont donnés dans la figure~\ref{fig:connecteurs}. 
...
Intéressons-nous maintenant à $\&$, l'autre connecteur issu du $\land$ du logique classique. La formule $A\& B$ représente la %possession
