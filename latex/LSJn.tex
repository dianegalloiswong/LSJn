...
\def\InterFeuilles{(1)*\DistanceInterFeuilles}
% Noeuds (MODIFIABLES : Styles et Coefficients d'InterFeuilles)
\node (R) at ({(2)*\InterFeuilles},{\NiveauA}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Ra) at ({(0.5)*\InterFeuilles},{\NiveauB}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Raa) at ({(0)*\InterFeuilles},{\NiveauC}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rab) at ({(1)*\InterFeuilles},{\NiveauC}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rb) at ({(3.5)*\InterFeuilles},{\NiveauB}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rba) at ({(2.5)*\InterFeuilles},{\NiveauC}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rbaa) at ({(2)*\InterFeuilles},{\NiveauD}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rbab) at ({(3)*\InterFeuilles},{\NiveauD}) {$\autour{\to}{11}{7}{D}{?}a$};
\node (Rbb) at ({(4.5)*\InterFeuilles},{\NiveauC}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rbba) at ({(4)*\InterFeuilles},{\NiveauD}) {$\autour{\to}{11}{7}{D}{?}$};
\node (Rbbb) at ({(5)*\InterFeuilles},{\NiveauD}) {$\autour{\to}{11}{7}{D}{?}$};
% Arcs (MODIFIABLES : Styles)
\draw (R)--(Ra);
\draw (Ra)--(Raa);
\draw (Ra)--(Rab);
