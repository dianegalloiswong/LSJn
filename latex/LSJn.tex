...
Par ailleurs, pour une formule donnée de la conclusion, on remarque qu'il y a au plus une instance telle que cette formule est la formule principale, et la règle associée ne dépend que de la formule. De plus toute instance ne correspondant pas à un axiome a une formule principale. Décider l'instance à considérer revient alors à choisir une formule principale. 
